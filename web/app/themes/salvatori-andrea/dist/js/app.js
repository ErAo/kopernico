...
Barba.Dispatcher.on('transitionCompleted', function (currentStatus, oldStatus, container) {
    ...
    function topH() {
        ...
        try {
            for (var _iterator = childerns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var childern = _step.value;
    ...
    var miBurger = document.getElementById('mi-burger'),
        fortoggle = 1;
    miBurger.addEventListener('click', function () {
        var childerns = document.getElementsByClassName('mi-burger-item');
        ...
        try {
            for (var _iterator2 = childerns[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var childern = _step2.value;
    ...
    if (cutText.length > 0) {
        ...
        try {
            for (var _iterator3 = cutText[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var cutTexts = _step3.value;
    ...
    function activitis() {
        ...
        if (conL) {
            var operation = function operation() {
                ...
                try {
                    for (var _iterator4 = conLchild[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            if (conL.offsetWidth > conP.offsetWidth) {
                document.getElementById('actividades-next').addEventListener('click', function () {
                    if (moveIt <= finalRes) {
                        if (sumaChil == 0) {
                            sumaChil = childLen;
                            operation();
                ...
                document.getElementById('actividades-prev').addEventListener('click', function () {
                    if (moveIt > 0) {
                        sumaChil = sumaChil - childLen;
                        operation();
                    } else {
    ...
    function equipo() {
        ...
        if (conL) {
            var operation = function operation() {
                ...
                try {
                    for (var _iterator5 = conLchild[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            if (conL.offsetWidth > conP.offsetWidth) {
                document.getElementById('equipo-next').addEventListener('click', function () {
                    if (moveIt <= finalRes) {
                        if (sumaChil == 0) {
                            sumaChil = childLen;
                            operation();
                ...
                document.getElementById('equipo-prev').addEventListener('click', function () {
                    if (moveIt > 0) {
                        sumaChil = sumaChil - childLen;
                        operation();
                    } else {
    ...
    function blog() {
        ...
        if (conL) {
            var operation = function operation() {
                ...
                try {
                    for (var _iterator6 = conLchild[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            ...
            if (conL.offsetWidth > conP.offsetWidth) {
                document.getElementById('blog-slider-next').addEventListener('click', function () {
                    if (moveIt <= finalRes) {
                        if (sumaChil == 0) {
                            sumaChil = childLen;
                            operation();
                ...
                document.getElementById('blog-slider-prev').addEventListener('click', function () {
                    if (moveIt > 0) {
                        sumaChil = sumaChil - childLen;
                        operation();
                    } else {
    ...
    function heroImg() {
        var item = document.getElementsByClassName('item-slider-hero'),
            itemText = document.getElementsByClassName('slider-hero-texto'),
            val = 0,
            valu = 0;
        ...
        if (item.length > 0) {
            var resizes = function resizes() {
                ...
                try {
                    for (var _iterator7 = itemText[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                        var itemTexts = _step7.value;
            ...
            var slideShow = function slideShow() {
                ...
                try {
                    for (var _iterator8 = item[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                        var items = _step8.value;
                ...
                try {
                    for (var _iterator9 = itemText[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                        var itemTexts = _step9.value;
            ...
            var intervalo = function intervalo() {
            ...
            document.getElementById('hero-slide-prev').addEventListener('click', function () {
                if (val > 0) {
                    val--;
                    valu = val;
                } else {
    ...
    function weareImg() {
        var item = document.getElementsByClassName('slider-img-nosotros'),
            itemText = document.getElementsByClassName('slider-text-nosotros'),
            val = 0,
            valu = 0;
        ...
        if (item.length > 0) {
            var resizes = function resizes() {
                ...
                try {
                    for (var _iterator10 = itemText[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                        var itemTexts = _step10.value;
            ...
            var slideShow = function slideShow() {
                ...
                try {
                    for (var _iterator12 = itemText[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                        var itemTexts = _step12.value;
            ...
            document.getElementById('slider-nosotros-prev').addEventListener('click', function () {
                if (val > 0) {
                    val--;
                    valu = val;
                } else {
    ...
    if (itemCat.length > 0) {
        var categoria = function categoria() {
            ...
            try {
                for (var _iterator14 = itemCat[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                    var itemCats = _step14.value;
            ...
            try {
                for (var _iterator15 = objetoCat[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                    var objetoCats = _step15.value;
        ...
        try {
            for (var _iterator13 = itemCat[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                var itemCats = _step13.value;
    ...
    if (caracteristica) {
        ...
        caracteristica.addEventListener('click', function (e) {
            e.preventDefault();
        ...
        incluye.addEventListener('click', function (e) {
            e.preventDefault();
